...
%--------------------------------- WPs -----------------------------
\newcommand{\RisksAndSolutions}[1]{\noindent
\begin{minipage}{0.98\textwidth}
\textbf{Possible risks, solutions to these risks: }\usefont{T1}{cmbr}{m}{n}\vspace{-1mm}    #1  \end{minipage}\vspace{1mm}}
\newcommand{\Success}[1]{\noindent
\begin{minipage}{0.98\textwidth}
\textbf{Success indicators: }\usefont{T1}{cmbr}{m}{n}\vspace{-1mm}    #1  \end{minipage}\vspace{1mm}}
