...
\textbf{D. Coeurjolly} \dav{(40 years old) is a Senior Tenured
  ...
  of the field (TOG, PAMI, IP, CVIU, PR, PRL, DAM, GMOD, C \& G,
  IVC\ldots), and more than 40 papers in peer-reviewed international
  conferences (SIGGRAPH, DGCI, ICPR, IWCIA\ldots).}
...
normal estimates are usually a key input of the an \dav{energy
