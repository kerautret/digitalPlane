...
\textbf{D. Coeurjolly} (40 years old) is a senior tenured
  ...
  conference.  From 2011 to Jan. 2015, he lead the \emph{m2disco} team
  at LIRIS and is now Director of the Fédération Informatique de Lyon
  (FR2000, CNRS). In 2009, he received a Bronze Medal from CNRS that
 ...
 \textbf{B. Kerautret} (41 year old) is Assistant Professor since 2005
 at the LORIA laboratory. He received a Ph.D degree in Computer
 Science from Bordeaux University (France) in 2004.  His research are
 focused on digital geometry, image processing and its application. He
 is also interested in Reproducible Research as active member of the
 IPOL Editorial Board journal and was at the initiative of the recent
 first workshop on Reproducible Research in Pattern Recognition in
 2016. He participate to the GeoDIB ANR project in 2006-2011 and co
 advised 2 Phd Thesis. Since 2017 he is the chair of the the Technical
 Committee 18 "Discrete Geometry" of IAPR (Int. Assoc. for Pattern
 Recognition) and co organize the International conference on Discrete
 Geometry for Computer Imagery (DGCI 2011) in Nancy. He has written
 ...
 DGTalTools project, part of DGtal dedicated to applications. In
 december 2017, he defended his Habilitation to conduct Researches.
...
part of a digital surface?\todo{deplacer les taches en chapeau de
  paragraphe ou alors changer le style}
...
normal estimates are usually a key input of the \dav{energy
  function minimization leading to regularized vertex positions.}  
...
support \dav{(Graphical Processing Units)},
it may be interesting to directly render the input data. \dav{Voxel
  based rendering techniques (\emph{e.g.}
  \cite{DBLP:conf/si3d/CrassinNLE09,}) can be used to
