...
resolution. Plane-probing algorithms and derived esimators will be implemented in \DGtal. % at T+24 ?
...
\todo{related works: normal estimation (especially parameter free), recognition of digital plane, pattern generation}

\noindent\textbf{Normal estimation on point clouds.}
%general methods,
polynomial fitting \cite{Hoppe1992,Cazals2005,Cazals2008}

VCM: \cite{Dey2006,Alliez2007,Merigot2011}
...
%The surface geometry within a patch around each surfel should be gathered to provide such estimations
%-- e.g. by convolution \cite{Pottmann2009} or polynomial fitting \cite{Cazals2008}.
%=> besoin d'un parametre
%convergent methods en 2D
