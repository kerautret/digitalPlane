...
we focus in this state of the art on user-defined parameters and we check if
...
\begin{figure}[htbp]
  ...
  \caption{Digitization of a 2D ellipse (a) at smaller and smaller grid steps $h$ (b-d).
    ...
    contour is an estimator that is not multigrid convergent since it returns the perimeter
    of the bounding box. TODO improve fig}
  \label{fig:multi}
\end{figure}
