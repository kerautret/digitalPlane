...
Other methods sum up the surface geometry within a ball.  

%Digital variant of VCM \cite{Cuel2015} has convergence guarantees
%for digitization of smooth shapes, but the radii must be adapted to the sampling grid step
