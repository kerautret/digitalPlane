...
the grid step. More related to the estimation of normal vector from organized point cloud data, Holzer {\etal}, proposed a real time surface normal estimation based on integral image. As mentionned by the authors the method souffer of limitation near edge regions from low or high depth changes.  
